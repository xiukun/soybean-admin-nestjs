...
import { $Enums, MenuType, Status } from '@prisma/client';
import {
  IsBoolean,
  IsInt,
  IsNotEmpty,
...
export class RouteCreateDto {
  ...
  @ApiProperty({
    ...
    nullable: true,
    type: 'string',
    description: 'ID of the associated lowcode page for lowcode menu type (auto-generated, read-only)',
    readOnly: true
  })
...
export class RouteUpdateDto {
  ...
  // 注意：lowcodePageId 字段被移除，不允许在更新时修改
}
