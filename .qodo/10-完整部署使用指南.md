...
| 低代码平台后端 | http://localhost:3003 | 核心业务API |
| API文档 | http://localhost:3003/api-docs | Swagger API文档 |
...
访问性能指标端点：
- http://localhost:3003/api/v1/health/metrics
- http://localhost:3003/api/v1/health/detailed
