...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  lowcode_model: () => import("@/views/lowcode/model/index.vue"),
  lowcode_page: () => import("@/views/lowcode/page/index.vue"),
  lowcode_preview: () => import("@/views/lowcode/preview/index.vue"),
