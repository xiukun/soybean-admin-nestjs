  ...
  <div class="generation-history">
    ...
    <NModal v-model:show="showDetailModal" preset="card" style="width: 90%; max-width: 1200px">
      ...
      <div v-if="selectedRecord" class="space-y-4">
        ...
        <!-- Errors (if any) -->
        <NCard
          v-if="selectedRecord.errors && selectedRecord.errors.length > 0"
          :title="$t('page.lowcode.codeGeneration.errors')"
          size="small"
        >
          <NAlert
        ...
        <!-- Generated Files -->
        <NCard
          v-if="selectedRecord.generatedFiles"
          :title="$t('page.lowcode.codeGeneration.generatedFiles')"
          size="small"
        >
          <NTree
