...
const basicRules: FormRules = {
  name: [{ required: true, message: $t('page.lowcode.project.config.nameRequired'), trigger: 'blur' }],
  code: [{ required: true, message: $t('page.lowcode.project.config.codeRequired'), trigger: 'blur' }]
};
...
const handleSave = async () => {
  ...
  const forms = [
    basicFormRef.value,
    techFormRef.value,
    generationFormRef.value,
    databaseFormRef.value,
        ...
        <NTabPane name="basic" :tab="$t('page.lowcode.project.config.basic')">
          ...
          >
            <NFormItem :label="$t('page.lowcode.project.config.projectName')" path="name">
              <NInput
                v-model:value="configForm.basic.name"
                :placeholder="$t('page.lowcode.project.config.projectNamePlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.projectCode')" path="code">
              <NInput
                v-model:value="configForm.basic.code"
                :placeholder="$t('page.lowcode.project.config.projectCodePlaceholder')"
                disabled
              />
            </NFormItem>
            ...
            <NFormItem :label="$t('page.lowcode.project.config.version')" path="version">
              <NInput
                v-model:value="configForm.basic.version"
                :placeholder="$t('page.lowcode.project.config.versionPlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.author')" path="author">
              <NInput
                v-model:value="configForm.basic.author"
                :placeholder="$t('page.lowcode.project.config.authorPlaceholder')"
              />
            </NFormItem>
          </NForm>
        </NTabPane>
        ...
        <NTabPane name="generation" :tab="$t('page.lowcode.project.config.codeGeneration')">
          <NForm ref="generationFormRef" :model="configForm.generation" label-placement="left" label-width="120px">
            <NFormItem :label="$t('page.lowcode.project.config.outputPath')">
              <NInput
                v-model:value="configForm.generation.outputPath"
                :placeholder="$t('page.lowcode.project.config.outputPathPlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.packageName')">
              <NInput
                v-model:value="configForm.generation.packageName"
                :placeholder="$t('page.lowcode.project.config.packageNamePlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.apiPrefix')">
              <NInput
                v-model:value="configForm.generation.apiPrefix"
                :placeholder="$t('page.lowcode.project.config.apiPrefixPlaceholder')"
              />
            </NFormItem>
        ...
        <NTabPane name="database" :tab="$t('page.lowcode.project.config.database')">
          <NForm ref="databaseFormRef" :model="configForm.database" label-placement="left" label-width="120px">
            ...
            <NFormItem :label="$t('page.lowcode.project.config.dbHost')">
              <NInput
                v-model:value="configForm.database.host"
                :placeholder="$t('page.lowcode.project.config.dbHostPlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.dbPort')">
              <NInputNumber
                v-model:value="configForm.database.port"
                :placeholder="$t('page.lowcode.project.config.dbPortPlaceholder')"
                style="width: 100%"
              />
            </NFormItem>
            ...
            <NFormItem :label="$t('page.lowcode.project.config.dbName')">
              <NInput
                v-model:value="configForm.database.name"
                :placeholder="$t('page.lowcode.project.config.dbNamePlaceholder')"
              />
            </NFormItem>

            <NFormItem :label="$t('page.lowcode.project.config.dbUsername')">
              <NInput
                v-model:value="configForm.database.username"
                :placeholder="$t('page.lowcode.project.config.dbUsernamePlaceholder')"
              />
            </NFormItem>
