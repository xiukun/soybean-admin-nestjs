    ...
    <div class="designer-header">
      ...
      <div class="header-center">
        <NSpace>
          ...
          <NButtonGroup>
            ...
            <NButton 
              size="small" 
              :type="currentMode === 'pan' ? 'primary' : 'default'"
              @click="setMode('pan')"
            >
              <template #icon>
      ...
      <div class="header-right">
        <NSpace>
          ...
          <NCheckbox v-model:checked="showMinimap" @update:checked="toggleMinimap">
            小地图
          </NCheckbox>
      ...
      <div class="right-panel" :class="{ collapsed: rightPanelCollapsed }">
        <div class="panel-header">
          ...
          <NButton text size="tiny" @click="rightPanelCollapsed = !rightPanelCollapsed">
            <NIcon><icon-mdi-chevron-right v-if="!rightPanelCollapsed" /><icon-mdi-chevron-left v-else /></NIcon>
          </NButton>
        </div>
        ...
        <div v-if="!rightPanelCollapsed" class="panel-content">
          ...
          <div v-else class="empty-selection">
            ...
            <NText depth="3" class="text-center mt-2">选择实体或关系以编辑属性</NText>
          </div>
        </div>
      </div>
    </div>
...
import { 
  NButton, NSpace, NText, NIcon, NButtonGroup, NDivider, 
  NCheckbox, NDropdown, useMessage 
} from 'naive-ui';
...
/**
 * 全屏实体关系设计器组件
 * @description 提供大空间的实体关系设计体验，支持多种布局算法和丰富的交互功能
 */
