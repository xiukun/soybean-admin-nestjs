...
import { NButton, NCheckbox, NForm, NFormItem, NInput, NModal, NSelect, NSpace } from 'naive-ui';
  ...
  >
    <NForm ref="formRef" :model="formData" :rules="rules" label-placement="left" label-width="100px">
      ...
      <NFormItem label="数据类型" path="dataType">
        <NSelect v-model:value="formData.dataType" :options="dataTypeOptions" placeholder="请选择数据类型" />
      </NFormItem>

      <NFormItem label="字段描述" path="description">
        <NInput v-model:value="formData.description" type="textarea" placeholder="请输入字段描述" :rows="3" />
      </NFormItem>
