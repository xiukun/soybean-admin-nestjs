import { FileControlPlugin } from 'amis-editor'
...
export class FileControlPluginRefactor extends FileControlPlugin {
        ...
        body: getSchemaTpl('collapseGroup', [
          {
            ...
            body: [
              ...
              getSchemaTpl('uploadType', {
                ...
                onChange: (value: any, _oldValue: boolean, _model: any, form: any) => {
                  if (value === 'asForm') {
                    // 作为表单数据，自动上传开启
                    form.setValueByName('autoUpload', true)
                    const formType = form.getValueByName('formType') || 'asBlob'
...

              {
                ...
                visibleOn: 'this.uploadType !== "asForm" && this.useChunk === true',
                body: [
                  {
                    type: 'input-group',
                    name: 'chunkSize',
                  ...
                  {
                    type: 'Container',
                    visibleOn: 'this.uploadType == "fileReceptor" && this.useChunk != false',
                    body: [
              ...
              getSchemaTpl('apiControl', {
                ...
                __isUpload: true,
                visibleOn: 'this.uploadType === "fileReceptor" && !this.useChunk',
              }),
              {
                type: 'input-text',
                value: '',
                name: 'accept',
                label: tipedLabel('文件类型', '请填入文件的后缀，多个类型用<code>,</code>隔开'),
              },
