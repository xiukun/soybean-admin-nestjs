import { RichTextControlPlugin } from 'amis-editor'
...
export class RichTextControlPluginRefactor extends RichTextControlPlugin {
    ...
    return getSchemaTpl('tabs', [
      {
        ...
        body: getSchemaTpl('collapseGroup', [
          ...
          getSchemaTpl('agValidation', { tag: ValidatorTag.Code }),
        ]),
      },
      {
        title: '外观',
