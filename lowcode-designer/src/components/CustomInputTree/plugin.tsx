...
import { TreeControlPlugin } from 'amis-editor'
import {
  BaseEventContext,
  defaultValue,
  getI18nEnabled,
...
export class TreeControlPluginRefactor extends TreeControlPlugin {
        ...
        body: getSchemaTpl('collapseGroup', [
          {
            ...
            body: [
              ...
              getSchemaTpl('switch', {
                ...
                name: 'withChildren',
                hiddenOn: '!this.multiple || !this.autoCheckChildren && this.cascade',
              }),
              getSchemaTpl('switch', {
                label: tipedLabel(
                  '值只含子节点',
          ...
          getSchemaTpl('agValidation', { tag: ValidatorTag.Tree }),
        ]),
      },
      {
        title: '外观',
