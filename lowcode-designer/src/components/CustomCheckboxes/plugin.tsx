...
import { CheckboxesControlPlugin } from 'amis-editor'
import { getSchemaTpl, BaseEventContext, defaultValue } from 'amis-editor-core'
...
export class CheckboxesControlPluginRefacotr extends CheckboxesControlPlugin {
            ...
            },
            {
              ...
              body: [
                ...
                ...inputStateTpl('themeCss.checkboxesClassName', '', {
                  ...
                  hideMargin: true,
                  hidePadding: true,
                  hiddenOn: 'themeCss?.checkboxesShowClassName.display === "none"',
                  backgroundToken(state) {
                    const s = state.split('-')
                    if (s[0] === 'checked') {
                  ...
                  schema: [
                    ...
                    getSchemaTpl('theme:colorPicker', {
                      ...
                      visibleOn: '${__editorStatethemeCss.checkboxesClassName == "checked-hover"}',
                      label: '图标颜色',
                      labelMode: 'input',
                      editorValueToken: '--checkbox-${optionType}-checked-default-icon-color',
                    }),
