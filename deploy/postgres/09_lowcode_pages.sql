...
-- 插入低代码页面示例数据
INSERT INTO backend.sys_lowcode_page (id, name, title, code, description, schema, status, created_by) VALUES 
...
-- 插入低代码页面版本数据
INSERT INTO backend.sys_lowcode_page_version (id, page_id, version, schema, changelog, created_by) VALUES 
